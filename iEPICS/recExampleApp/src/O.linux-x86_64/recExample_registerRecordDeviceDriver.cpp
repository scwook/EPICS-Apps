...
/* Generated from ../O.Common/recExample.dbd */
...
int recExample_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/scwook/git/EPICS-Apps/iEPICS";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"recExample_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    recExample_registerRecordDeviceDriver(*iocshPpdbbase);
}
